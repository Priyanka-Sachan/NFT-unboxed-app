Moralis.Cloud.afterSave("ItemListed", async (request) => {
  ...
  if (confirmed) {
      ...
      query.equalTo("sellerAddress", request.object.get("sellerAddress"))
      ...
      activeItem.set("sellerAddress", request.object.get("sellerAddress"))
      logger.info(
...
Moralis.Cloud.afterSave("ItemDelete", async (request) => {
  const confirmed = request.object.get("confirmed")
  const logger = Moralis.Cloud.getLogger()
...
Moralis.Cloud.afterSave("ItemBought", async (request) => {
  ...
  if (confirmed) {
      ...
      logger.info(`NFTUnboxed | boughtItem: ${JSON.stringify(boughtItem)}`)
      if (boughtItem) {
