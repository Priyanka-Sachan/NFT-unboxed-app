    ...
    <div className={styles.container}>
      ...
      <div className={styles.landingpage}>
        <div className={styles.navbar}>
          <a className={styles.navlogo}>NFT Unboxed</a>
        ...
        <div className={styles.box}>
          <div className={styles.infobox}>
            <p className={styles['infobox-boldtext']}>
              Discover, collect, and charity in extraordinary NFT marketplace
            </p>
            <p className={styles['infobox-slimtext']}>
              In aenean posuere lorem risus nec. Tempor tincidunt aenean purus purus vestibulum nibh mi venenatis
            </p>
            <div className={styles['infobox-btnwrapper']}>
              <button className={[styles['infobox-explorebtn'], styles.selected].join(" ")}>Explore</button>
              <button className={styles['infobox-createbtn']}>Create</button>
            </div>
          </div>
          <div className={styles.display}>
            <img className={styles['display-nft']} layout='fill' src="https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="unsplash-OG44d93i-NJk" border="0" />
            <div className={styles.infowrapper}>
              <div className={styles.info}>
                <img className={styles['info-img']} layout='fill' src="https://images.unsplash.com/photo-1535207010348-71e47296838a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=385&q=80" alt="unsplash-OG44d93i-NJk" border="0" />
                <div>
                  <p>Laura</p>
                  <p>0.21 Weth</p>
                </div>
        ...
        <div className={styles.started}>
          <p className={styles['started-boldtext']}>Getting started</p>
          <p className={styles['started-slimtext']}>Eu, molestie commodo, enim pellentesque turpis integer sagittis</p>
          <div className={styles['started-items']}>
            <div className={styles.itemwrapper}>
              <div className={styles['started-items-item']}>
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36">
                  <path style={{ stroke: 'none', fillRule: 'nonzero', fill: '#bdbdbd', fillOpacity: '1' }} d="M24.7969 14.6719c.4375-.4414.4375-1.1524 0-1.5938-.4414-.4375-1.1524-.4375-1.5938 0L16.5 19.7851l-2.9531-2.957c-.4414-.4375-1.1524-.4375-1.5938 0-.4375.4414-.4375 1.1524 0 1.5938l3.75 3.75a1.1246 1.1246 0 0 0 1.5938 0Zm0 0" />
                  <path style={{ stroke: 'none', fillRule: 'evenodd', fill: '#bdbdbd', fillOpacity: '1' }} d="M18.8086.957a2.6005 2.6005 0 0 0-1.6172 0L4.8164 4.9688C3.7344 5.3202 3 6.3241 3 7.4648V15c0 9.2852 5.6563 16.0586 14.1016 19.246a2.5853 2.5853 0 0 0 1.7968 0C27.3438 31.0587 33 24.2853 33 15V7.4648a2.6182 2.6182 0 0 0-1.8164-2.496Zm-.9219 2.1368a.3738.3738 0 0 1 .2266 0l12.375 4.0117c.1601.0547.2617.1992.2617.3593V15c0 8.1914-4.9219 14.2227-12.6445 17.1367a.2815.2815 0 0 1-.211 0C10.172 29.2227 5.25 23.1914 5.25 15V7.4648c0-.1601.1016-.3046.2617-.3593Zm0 0" />
                </svg>
              </div>
        ...
        <div className={styles.footer2}>
          <div></div>
          <p>Distributed with ❤️ and WEB3</p>
        </div>
      </div>
    </div>
  )
